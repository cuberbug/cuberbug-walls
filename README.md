...
>Рекомендуется использовать `manager.sh`! Однако, в качестве альтернативы возможен и ручной запуск скриптов в основной логикой в случае, если вы не хотите устанавливать `gum` для работы интерактивного меню.
