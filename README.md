...
>❗ Внимание! Инструменты переехали в [отдельный репозиторий](https://github.com/cuberbug/repo-tools). Для их подключения необходимо выполнить `git clone --recurse-submodules`. Позже процесс подключения и обновления сабмодуля будет автоматизирован.
