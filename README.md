...
Для оптимизации хранения я вручную использую инструменты для апскейлинга и сжатия изображений.

* [WebP](https://developers.google.com/speed/webp?hl=ru) формат, выбранный мною в качестве основного
    * [cwebp](https://developers.google.com/speed/webp/docs/cwebp?hl=ru) для работы со сжатием
    * [ImageMagick](https://github.com/nihui/waifu2x-ncnn-vulkan) — вспомогательный инструмент, иногда используется для конвертации
